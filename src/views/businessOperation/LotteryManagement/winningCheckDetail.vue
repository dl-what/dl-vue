<template>
  <div class="vlt-card">
    <div class="detail">
      <panel :show="true" title="彩票信息" style="margin-bottom:20px">
        ...
        <div style="padding: 0 20px 20px;">
          <el-table :data="tableData" border>
            ...
            <el-table-column label="中奖奖等" prop="gradeType" min-width="120px">
      ...
      <panel :show="true" title="兑奖人信息" style="margin-bottom:20px">
  ...
  data() {
    return {
      ...
      redeemPeoleTitle: [
        ...
        // { title: "负责人", value: "", prop: "responsible" }
      ],
      actualTax: "",
      tableData: [],
    };
