<template>
  <div class="vlt-card">
    <panel title="提现记录详情" style="margin-top: 10px;" :show="true">
  ...
  data() {
    return {
      infoList: [
        ...
        { title: "会员卡号/投注卡号", value: "", prop: "accountCode" },
        ...
        { title: "提现金额", value: "", prop: "orderAmount" },
        { title: "提现方式", value: "", prop: "payType" },
        { title: "账户余额", value: "", prop: "balanceAmount" },
        { title: "操作员ID", value: "", prop: "operatorId" },
        { title: "操作员姓名", value: "", prop: "operatorName" },
