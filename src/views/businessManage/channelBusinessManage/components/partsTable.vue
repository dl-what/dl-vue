<template>
  <div>
    ...
    <el-table :data="tableData" border>
      ...
      <el-table-column label="配件名称" prop="deviceName"></el-table-column>
      <el-table-column label="配件型号" prop="deviceModel"></el-table-column> 
      <el-table-column label="配件状态" prop="status">
      ...
      <el-table-column label="配件序列号" prop="serial"></el-table-column>
    </el-table>
    <table-paging
      position="right"
      :total="total"
