...
<div class="vlt-card">
  ...
  <el-table :data="tableData" border style="width: 100%">
    ...
    <el-table-column prop="goodsName" label="设备名称" min-width="140px"></el-table-column>
    <el-table-column prop="deviceModel" label="设备型号" min-width="140px"></el-table-column>
    <el-table-column prop="sequenceCode" label="序列号" min-width="160px"></el-table-column>
    ...
    <el-table-column prop="warName" label="仓库名称" fixed="right" min-width="200px"></el-table-column>
