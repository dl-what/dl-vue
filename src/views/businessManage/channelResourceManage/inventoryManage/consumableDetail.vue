...
<div class="vlt-card">
  <div class="consumable-detail">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="goodsName" label="耗材名称" min-width="160px"></el-table-column>
      <el-table-column prop="inOutType" label="出入库类型" min-width="140px">
        <template slot-scope="scope">
          <span
          class="icon-tag"
          :class="{
      ...
      <el-table-column prop="warName" label="仓库名称" min-width="200px"></el-table-column>
    </el-table>
